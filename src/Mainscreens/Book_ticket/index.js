...
export default class Book extends React.Component{
    ...
    UNSAFE_componentWillMount = async () => {
        ...
        const moviename=this.props.route.params.moviename;
        const movies=this.props.route.params.moviearray
        ...
        return(
            <View style={ styles.container }>
                ...
                <BackHeader
                 ...
                 title={this.props.route.params.moviename}
                 fontSize={15}
                />
             ...
             <View style={styles.rowitems}>
               ...
               <View style = { styles.moviedetail }>
                   ...
                   <Text style={{marginRight: 80,marginLeft: 5,color:colors.dark_grey, fontFamily:LucidaHandwritingItalic,}}>{cast}</Text>
               </View>
            </View>
