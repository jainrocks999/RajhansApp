...
class Orderpage extends React.Component{
    state = { 
     ...
     UNSAFE_componentWillMount = () =>{
        ...
        const oid= this.props.route.params.order_id
        const oarr=this.props.route.params.order_array
        const cs=  this.props.route.params.showcount
     ...
     confirmBook = (oids,onames,ouids) =>{
        ...
        url:'/confirmOrder/?order_id='+oids+'&profileemail='+onames+'&currentUser='+ouids+'&method=7',navigation:this.props.navigation})
      
     }

     cancelOrder = (orrid,uuid) =>{
        this.props.dispatch({type:'Cancel_Booking_Request',url:'/newcancelorder/?orderid='+orrid+'&user_id='+uuid+'&is_admin=NO',navigation:this.props.navigation})
