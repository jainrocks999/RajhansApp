...
const HomeList=({movie,navigation})=>{
  ...
  const _btnVerify = (item) =>{
   ...
   const renderSeparator=()=>{
        return <View style={{height:1,backgroundColor:colors.grey,width:'70%',alignSelf:'flex-end'}}/>
      }
        ...
        renderItem={({ item }) => (
         ...
         <View style={styles.rowitems}>
            ...
            <View style = { styles.moviedetail }>
                 <Text style={styles.rowtitle}>{item.movie_name}</Text>
                {_btnVerify(item)}
            </View>
         </View>
       </View> 
